...
public class SampleClient {
    ...
    public static void main(String[] args) {
        ...
        String sellerEmail = String.format("Your %s auction sold to %s for %n", buyerAuction.getItemDescription(), buyerAuction.getHighBidder().getUserEmail(), buyerAuction.getCurrentBid());
        String buyerEmail = String.format("Congratulations! You won an buyerAuction for %s from %s for %n", buyerAuction.getItemDescription(), buyerAuction.getSeller().getUserEmail(), buyerAuction.getCurrentBid());
